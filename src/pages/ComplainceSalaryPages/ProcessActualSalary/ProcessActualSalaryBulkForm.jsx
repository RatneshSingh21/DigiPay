...
const ProcessActualSalaryBulkForm = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axiosInstance.post(
                `/ActualSalary/bulk/${salaryRunId}?month=${month.value}&year=${year.value}`
            );
            toast.success("Bulk salary processed successfully!");
            onClose?.();
        } catch (error) {
            toast.error("Failed to process bulk salary");
        } finally {
            setLoading(false);
        }
    };
...
export default ProcessActualSalaryBulkForm;