...
const ProcessActualSalaryForm = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axiosInstance.post("/ActualSalary/process", {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-2">
                ...
                <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                    <h2 className="text-xl font-semibold text-gray-800">Process Employee Actual Salary</h2>
                ...
                <div className="flex justify-end px-6 py-4 border-t border-gray-200 gap-2">
                    ...
                    <button
                        ...
                        className="px-4 py-2 rounded bg-primary text-white cursor-pointer hover:bg-secondary disabled:opacity-50"
                    >
...
export default ProcessActualSalaryForm;