...
const DifferenceSalaryForm = ({ onClose }) => {
    ...
    // ─── Auto-generate Salary Run ID on month/year change ─────────────
    useEffect(() => {
        if (month && year) {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axiosInstance.post("/cps/payment-diff/process", {
            ...
            if (res.data?.data?.success) {
                toast.success("Difference salary processed successfully!");
                onClose?.();
            } else {
                toast.error(res.data?.data?.errorMessage || "Processing failed");
            }
        } catch (error) {
            toast.error("Failed to process difference salary");
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-2">
                ...
                <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                    <h2 className="text-xl font-semibold text-gray-800">Process Difference Salary</h2>
                ...
                <form className="px-6 py-4 space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            Format <strong>YYYYMM</strong>, auto-generated from Month & Year
                        </p>
                    </div>
                </form>
...
export default DifferenceSalaryForm;