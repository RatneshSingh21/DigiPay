...
const ImportDepartment = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-30 backdrop-blur-sm z-50 flex items-center justify-center px-4">
      <div className="w-full max-w-3xl bg-white p-6 rounded-lg shadow-xl relative">
        {/* Close button */}
        <button
        ...
        <p className="text-gray-700 mb-6">
          ...
          and compare it with your import file to ensure that the file is ready
          to import.
        </p>
