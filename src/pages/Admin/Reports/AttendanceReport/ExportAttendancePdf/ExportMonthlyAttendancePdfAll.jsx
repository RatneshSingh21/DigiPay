...
const ExportMonthlyAttendancePdfAll = ({ isOpen, onClose }) => {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.get(
                "/AttendanceRecord/monthly-attendance-report-pdf",
                {
                    params: {
                        month: month.value,
                        year: Number(year),
            ...
            link.href = url;
            link.download = `Attendance_Report_${month.value}_${year}.pdf`;
...
export default ExportMonthlyAttendancePdfAll;