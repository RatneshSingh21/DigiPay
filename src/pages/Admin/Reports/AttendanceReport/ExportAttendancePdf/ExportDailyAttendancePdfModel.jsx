...
const ExportDailyAttendancePdfModel = ({ isOpen, onClose }) => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `/Attendance/export-monthly-pdf/employee/${selectedEmployee.value}`,
        {
      ...
      link.href = url;
      link.download = `Attendance_${selectedEmployee.label}_${month.value}_${year}.pdf`;
...
export default ExportDailyAttendancePdfModel;
