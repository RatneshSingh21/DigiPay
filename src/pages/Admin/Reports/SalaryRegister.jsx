        ...
        {dummyTemplates.map((template) => (
          ...
          >
            ...
            <button
              ...
              className="mt-4 flex items-center justify-center gap-2 text-primary cursor-pointer font-medium border border-primary hover:bg-primary hover:text-white transition px-3 py-2 rounded-md"
            >
              <FiDownload />
              Download Preview
            </button>
