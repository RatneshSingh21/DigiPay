  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between text-xs text-orange-500 font-semibold mt-3">
        <button type="button" className="hover:underline" onClick={() => navigate("/login-otp")}>Login with OTP</button>
        <button type="button" className="hover:underline" onClick={() => navigate("/forget-password")}>Forgot Password?</button>
      </div>
