...
const SalaryExportDefault = ({ onClose }) => {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.get(
                `/CalculatedSalary/export-rich-salary`,
                {
                    params: {
                        month: month.value,
                        year: year,
            ...
            // Get filename from API header
            const contentDisposition = response.headers["content-disposition"];

            let fileName = `Payroll_${month.value}_${year}.xlsx`;
...
export default SalaryExportDefault;
