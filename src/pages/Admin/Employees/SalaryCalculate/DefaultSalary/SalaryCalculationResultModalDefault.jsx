...
const SalaryCalculationResultModalDefault = ({ data, onClose }) => {
    if (!data) return null;

    const components =
        typeof data.componentBreakdown === "string"
            ? JSON.parse(data.componentBreakdown)
...
export default SalaryCalculationResultModalDefault;