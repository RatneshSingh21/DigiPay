...
import ComponentLockForm from "./ComponentLockForm";
  ...
  const fetchInitialData = async () => {
    try {
      const [locksRes, usersRes] = await Promise.all([
        axiosInstance.get("/component-locks"),
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        {locks.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-gray-500">
            ...
            <p className="text-sm font-medium">No Component Locks Found</p>

            <p className="text-xs text-gray-400 mt-1 text-center max-w-sm">
              Component has not been locked for any month yet.
            </p>
