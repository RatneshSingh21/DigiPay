...
const labelToPath = {
  ...
  "Payroll Attendance": "attendance-manipulation",
  "Attendance TestData": "attendance-testdata",
  "Actual Salary": "actual-salary",
  "Process Actual Salary": "process-actual-salary",
  "Process Compliance Salary": "process-complaince-salary",
  "Process Salary Input": "process-salary-input",
...
const labelToIcon = {
  ...
  "Payroll Attendance": <UserCheck size={16} className="mr-2" />,
  "Attendance TestData": <LandmarkIcon size={16} className="mr-2" />,
  "Actual Salary": <LandmarkIcon size={16} className="mr-2" />,
  "Process Actual Salary": <LandmarkIcon size={16} className="mr-2" />,
  "Process Compliance Salary": <LandmarkIcon size={16} className="mr-2" />,
  "Process Salary Input": <LandmarkIcon size={16} className="mr-2" />,
  ...
  "Monthly Attendance Report": <FileText size={16} className="mr-2" />,
