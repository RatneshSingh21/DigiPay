...
export const getEmployeeESIDetails = () =>
  axiosInstance.get("/EmployeeESIDetails");
export const getEmployeeESIDetailById = (id) =>
  axiosInstance.get(`/EmployeeESIDetails/${id}`);
export const saveEmployeeESIDetail = (data) =>
  axiosInstance.post("/EmployeeESIDetails", data);

// ---------- ESI Contribution ----------
export const getAllESITransactions = () => {
  return axiosInstance.get("/ESIContributionTransaction/all");
};
export const getESITransactionById = (id) =>
  axiosInstance.get(`/ESIContributionTransaction/${id}`);
